...
TODO: factor out fixtures and/or tests that are identical for BRAVO and other methods and
are calculated in factored-out code,
e.g. test_compute_margins()
sampler fixture (shared with test_bravo.py and test_sampler.py)
...
def test_compute_risk(sampler):
    ...
    expected_Ts = {
            ...
            'test_mercer': {('cand1', 'cand2'): 0.0005882801239973617},
    }
